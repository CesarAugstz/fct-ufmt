...
import type { ContentNature, BlockSize, Alignment } from '@zenstackhq/runtime/models';

export function useCheckContentBlock<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: string; nature?: ContentNature; content?: string; caption?: string; size?: BlockSize; alignment?: Alignment; order?: number; courseId?: string; fileId?: string }; }, options?: (Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
