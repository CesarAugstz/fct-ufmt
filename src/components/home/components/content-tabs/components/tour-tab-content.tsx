      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="p-6 md:p-8">
          ...
          <p className="text-gray-600 mb-6">
            Explore as instalações da FCT através do nosso tour virtual
            interativo.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <TourInfoCard
              title="Laboratórios"
              description="Conheça nossos laboratórios de pesquisa e ensino."
            />
            <TourInfoCard
              title="Salas de Aula"
              description="Visite nossas modernas salas de aula."
            />
            <TourInfoCard
              title="Áreas Comuns"
              description="Explore os espaços de convivência e estudo."
            />
          </div>
        </div>
      </div>
