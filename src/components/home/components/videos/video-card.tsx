        ...
        <div className="relative group">
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-black/20 group-hover:bg-black/40 transition-colors">
            <div className="w-14 h-14 rounded-full bg-white/90 flex items-center justify-center transform group-hover:scale-110 transition-transform">
              <div className="w-0 h-0 border-y-8 border-y-transparent border-l-12 border-l-[#003366] ml-1"></div>
            </div>
          </div>
        </div>
        <div className="p-4">
          <h3 className="font-medium text-gray-800 mb-1">Vídeo institucional {index}</h3>
          ...
          <Button variant="link" className="text-[#0088cc] p-0 hover:text-[#0088cc]/80 group">
            Assistir <ArrowRight className="ml-1 h-4 w-4 group-hover:translate-x-1 transition-transform" />
          </Button>
        </div>
      </CardContent>
    </Card>
